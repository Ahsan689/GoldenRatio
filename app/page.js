...
gsap.set(".skewElem", {transformOrigin: "right center", force3D: true});
  ...
  return (
    <Layout>
      ...
      <header id='header' className="fixed-top d-flex  justify-content-start  header-transparent">
        <nav id='navbar' className="navbar" >
          <ul style={{marginTop:"50%", flexDirection:'column'}} >
            <li><a style={{marginLeft:60}} className="nav-link scrollto active" href="#hero"><img width={50} height={50} src="/assets/img/HOME.png" alt/></a></li>
            <li><a style={{marginLeft:60}} className="nav-link scrollto" href="#about"><img  width={50} height={50} src="/assets/img/ABOUT US.png" alt/></a></li>
            <li><a style={{marginLeft:60}} className="nav-link scrollto" href="#services"><img  width={48} height={48} src="/assets/img/SERVICES.png" alt/></a></li>
            <li><a style={{marginLeft:60}} className="nav-link scrollto " href="#portfolio"><img width={50} height={50} src="/assets/img/portfolio.png" alt/></a></li>
            ...
            <li><a style={{marginLeft:60}} className="nav-link scrollto" href="#contact"><img width={50} height={50} src="/assets/img/CONTACT US.png" alt/></a></li>
          </ul>
    ...
    <Image width={400} height={400} src="/assets/img/01-26 (1).jpg" alt className="skewElem skewElementclass" />
    <Image width={400} height={400} src="/assets/img/02-28 (1).jpg" alt className="skewElem skewElementclass" />
    <Image width={400} height={400} src="/assets/img/04-23 (1).jpg" alt className="skewElem skewElementclass" />
    <Image width={400} height={400} src="/assets/img/03.png" alt className="skewElem skewElementclass" />
    <Image width={400} height={400} src="/assets/img/04.png" alt className="skewElem skewElementclass" />
    <Image width={400} height={400} src="/assets/img/05.png" alt className="skewElem skewElementclass" />
    <Image width={400} height={400} src="/assets/img/VIEW 01.jpg" alt className="skewElem skewElementclass" />
    <Image width={400} height={400} src="/assets/img/VIEW 02.jpg" alt className="skewElem skewElementclass" />
    <Image width={400} height={400} src="/assets/img/VIEW 03.jpg" alt className="skewElem skewElementclass" />
        ...
        <section id="portfolio" className="portfolio">
          <div className="container">
            ...
            <ul id="portfolio-flters" className="d-flex justify-content-center">
              ...
              <li data-filter=".filter-web">Residential</li>
            </ul>
            <div className="row portfolio-container">
              <div className="col-lg-4 col-md-6 portfolio-item filter-app">
                <div className="portfolio-img"><img src="assets/img/commercial.png" className="img-fluid" alt /></div>
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-web">
                <div className="portfolio-img"><img src="assets/img/interior.png" className="img-fluid" alt /></div>
                <div className="portfolio-info">
                  <h4>Web 3</h4>
                  <p>Web</p>
              ...
              {/* <div className="col-lg-4 col-md-6 portfolio-item filter-app">
                <div className="portfolio-img"><img src="assets/img/residentia.png" className="img-fluid" alt /></div>
                <div className="portfolio-info">
                  <h4>App 2</h4>
                  <p>App</p>
